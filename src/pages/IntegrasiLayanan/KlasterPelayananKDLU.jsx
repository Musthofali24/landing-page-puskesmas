...
import { FaUserMd, FaWheelchair, FaArrowRight } from "react-icons/fa";

export const KlasterPelayananKDLU = () => {
  useTitle("Klaster Pelayanan KDLU");
  // Data untuk 2 pelayanan KDLU
  const kdluData = [
    {
      id: 1,
      icon: FaUserMd,
  ...
  const breadcrumbItems = [
    ...
    { label: "Klaster Pelayanan Kesehatan Usia Dewasa dan Lanjut Usia" },
  ];
      ...
      <div className="dark:bg-black">
        <div className="max-w-7xl px-4 py-16 mx-auto">
          ...
          <div className="mb-12">
            ...
            {/* Page Title */}
            <h1 className="leading-tight text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-4">
              Klaster Pelayanan Kesehatan <br /> Usia Dewasa dan Lanjut Usia
            </h1>
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl leading-relaxed mt-4">
              Pelayanan kesehatan komprehensif untuk menjaga dan meningkatkan
              kualitas hidup usia dewasa dan lanjut usia melalui pendekatan
              preventif, promotif, kuratif, dan rehabilitatif yang terintegrasi.
            </p>
          </div>
