...
import maklumatPelayanan from "../../assets/MaklumatPelayanan/MaklumatPelayanan.webp";
        ...
        <div className="bg-white dark:bg-black pt-16">
          <div className="max-w-7xl px-4 mx-auto">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mt-4">
              Maklumat Pelayanan UPTD Puskesmas Garuda
            </p>
          </div>
        </div>
