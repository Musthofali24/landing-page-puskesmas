...
import tujuanPuskesmas from "../../assets/TujuanPuskesmas/TujuanPuskesmas.webp";

export const TujuanPuskesmas = () => {
  useTitle("Tujuan Puskesmas");
  const [isModalOpen, setIsModalOpen] = useState(false);

  // Breadcrumb items
  const breadcrumbItems = [
    { label: "Tentang Kami", href: "#" },
    { label: "Tujuan Puskesmas" },
  ];
