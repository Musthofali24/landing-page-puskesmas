...
import pelayananRawatJalan from "../../assets/AlurPelayanan/PelayananRawatJalan.webp";
import pelayananPONED from "../../assets/AlurPelayanan/PelayananPONED.webp";
import tindakanGawatDarurat from "../../assets/AlurPelayanan/TindakanGawatDarurat.webp";

export const AlurPelayanan = () => {
  ...
  const alurPelayanan = [
    {
      image: pelayananRawatJalan,
      title: "Pelayanan Rawat Jalan",
    },
    {
      image: pelayananPONED,
      title: "Pelayanan PONED",
    },
    {
      image: tindakanGawatDarurat,
        ...
        <div className="bg-white dark:bg-black pt-16">
          <div className="max-w-7xl px-4 mx-auto">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mt-4">
              Alur Pelayanan UPTD Puskesmas Garuda
            </p>
          </div>
        </div>
